...
class BaseRepository implements BaseRepositoryInterface
{
     ...
     * @return Collection
     */
    public function paginate($limit = null, array $columns = ['*'], array $relations = []): Paginator
    {
        return $this->model->with($relations)->simplePaginate($limit ?: $this->model->perPage, $columns);
    }
